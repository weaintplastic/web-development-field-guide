<?php
    ...
    class DauxHelper {
        ...
        public static function configure_theme($theme, $base_url, $local_base, $theme_url, $mode = Daux::LIVE_MODE, $template = 'default') {
            ...
            if (!isset($theme['template'])) $theme['template'] = $local_base . DIRECTORY_SEPARATOR . 'templates' .
                DIRECTORY_SEPARATOR . $template . '/default.tpl';
            ...
            if (!isset($theme['error-template'])) $theme['error-template'] = $local_base . DIRECTORY_SEPARATOR . 'templates' .
                DIRECTORY_SEPARATOR . $template . '/error.tpl';
...
EOT;
        ...
        public static function clean_copy_assets($path, $local_base){
            ...
            @mkdir($path . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR . 'weaintplastic');
            @mkdir($path . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR . 'weaintplastic' . DIRECTORY_SEPARATOR . 'themes');
            static::copy_recursive($local_base . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR .
                'weaintplastic' . DIRECTORY_SEPARATOR . 'themes', $path . DIRECTORY_SEPARATOR . 'templates' .
                DIRECTORY_SEPARATOR . 'weaintplastic' . DIRECTORY_SEPARATOR . 'themes');
            //
        }
