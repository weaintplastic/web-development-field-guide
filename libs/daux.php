<?php
    ...
    class Daux
    {
        ...
        private function recursive_generate_static($tree, $output_dir, $params, $base_url = '') {
            ...
            $params['theme'] = DauxHelper::rebase_theme($params['theme'], $base_url, $params['base_url'] . "templates/" . $params['template'] . "/themes/" . $params['theme']['name'] . '/');
            ...
            switch ($mode) {
                ...
                case ErrorPage::MISSING_PAGE_ERROR_TYPE:
                    ...
                    $params['theme'] = DauxHelper::configure_theme($this->local_base . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR .
                        ...
                        $this->local_base, $params['base_url'] . "templates/" . $params['template'] . "/themes/" . $this->options['theme'] . '/', $mode, $this->options['template']);
                    break;
