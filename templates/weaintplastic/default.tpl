...
<body>
    <?php if ($homepage) { ?>
    <!-- Homepage -->
        <div class="navbar navbar-fixed-top hidden-print hidden-xs hidden-sm hidden-md hidden-lg">
            <div class="container">
        ...
        <div class="homepage-footer well container-fluid hidden-xs hidden-sm hidden-md hidden-lg">
            <div class="container">
                <div class="row">
        ...
        <div class="container-fluid fluid-height wrapper">
            <div class="navbar navbar-fixed-top hidden-print">
                <div class="container-fluid">
                    <a class="brand navbar-brand" href="<?php echo $index;?>"><span><?php echo $project_title; ?></span></a>
                </div>
            </div>
