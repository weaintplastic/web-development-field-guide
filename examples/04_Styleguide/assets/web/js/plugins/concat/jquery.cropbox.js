    ...
    Crop.prototype = {
      init: function () {
        ...
        var defaultControls = $('<div/>', { 'class' : 'cropControls' })
              ...
              .append($('<a href="#" class="button button-solid button-solid-blue-light button-icon-only button-s cropZoomIn" ><i class="icon"><span>+</span></i></a>').on('click', $.proxy(this.zoomIn, this)))
              .append($('<a href="#" class="button button-solid button-solid-blue-light button-icon-only button-s cropZoomOut" ><i class="icon"><span>-</span></i></a>').on('click', $.proxy(this.zoomOut, this)));
